...
## Project Structure
    ...
    ├── figma_import_test_d_22739  # Django project configurations
...
1. Clone this repo and `cd figma_import_test_d_22739`
...
2. Clone this repo and `cd figma_import_test_d_22739`
